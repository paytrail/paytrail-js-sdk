...
import { CreateSiSPaymentRequest } from '../models/request/create-shop-in-shop-payment.model';
...
import { CreateSiSPaymentResponse } from '../models/response/create-shop-in-shop-payment.model';
...
export interface IPaytrail {
    ...
    /**
     *
     * @summary HTTP POST /payments creates shop in shop
     *
     *          Once the payment has been completed the client browser will return to the merchant provided redirect URL.

...
describe('create-mit-payment-charge', () => {
  ...
  it('should return status 200', async () => {
    ...
    const data = await client.createMitPaymentCharge(standardData)
  ...
  it('should return status 400', async () => {
    ...
    const data = await client.createMitPaymentCharge(nonStandardData)
  ...
  it('should handle API error', async () => {
    ...
    try {
      standardData.token = token
      await client.createMitPaymentCharge(standardData)
    } catch (error) {

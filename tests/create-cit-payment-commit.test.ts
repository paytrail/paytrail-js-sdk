...
describe('create-cit-payment-commit', () => {
  ...
  it('should return status 200', async () => {
    const params = new CreateCitPaymentParams()
    params.transactionId = '0e056dd8-408f-11ee-9cb4-e3059a523029'

    const data = await client.createCitPaymentCommit(params, standardData)
  ...
  it('should return status 400', async () => {
    ...
    const data = await client.createCitPaymentCommit(params, nonStandardData)
  ...
  it('should handle API error', async () => {
    ...
    try {
      ...
      await client.createCitPaymentCommit(params, standardData)
    } catch (error) {

...
describe('create-cit-payment-authorization-hold', () => {
  ...
  it('should return status 200', async () => {
    ...
    const data = await client.createCitPaymentAuthorizationHold(standardData)
  ...
  it('should return status 400', async () => {
    ...
    const data = await client.createCitPaymentAuthorizationHold(nonStandardData)
  ...
  it('should handle API error', async () => {
    ...
    jest.spyOn(api.tokenPayments, 'createCitPaymentAuthorizationHold').mockRejectedValue(mockError)

    try {
      standardData.token = token
      await client.createCitPaymentAuthorizationHold(standardData)
    } catch (error) {
